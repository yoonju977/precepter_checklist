...
const ROLES: { role: Role; desc: string; color: string }[] = [
  { role: 'preceptee', desc: '자가평가 점수·메모 입력', color: 'bg-blue-50 border-blue-300 hover:bg-blue-100' },
  { role: 'preceptor', desc: '프리셉티 자가평가 확인 + 평가 입력', color: 'bg-green-50 border-green-300 hover:bg-green-100' },
  { role: 'educator', desc: '회색 문항(교육전담 담당) 평가 입력', color: 'bg-yellow-50 border-yellow-300 hover:bg-yellow-100' },
